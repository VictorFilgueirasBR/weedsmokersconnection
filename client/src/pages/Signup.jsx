...
            // 2. Redireciona o usuário para a página de checkout.
            // Corrigido para a rota correta `/checkout`
            navigate(`/checkout?userId=${userId}&userEmail=${userEmail}&plan=${selectedPlan}&amount=${planOptions[selectedPlan].amount}`);
            
        } catch (error) {
...
                });
                // Redireciona para a rota correta do checkout com o userId retornado pelo backend
                const { userId } = error.response.data;
                navigate(`/checkout?userId=${userId}&userEmail=${formData.email}&plan=${selectedPlan}`);
            } else {
