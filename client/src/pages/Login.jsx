...
const Login = () => {
  ...
  const handleGoogleCredentialResponse = async (response) => {
    ...
    try {
      const backendResponse = await axios.post(`https://api.weedsmokersconnection.com/api/auth/google-login`, { // Alteração feita aqui
  ...
  useEffect(() => {
    if (window.google) {
      ...
      window.google.accounts.id.renderButton(
        ...
        {
          theme: "outline", // Alterado para um tema com fundo
          size: "large",
          text: "signin_with",
          width: 350,
          shape: "pill",
