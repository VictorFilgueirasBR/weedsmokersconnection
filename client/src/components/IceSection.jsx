...
- Full Melt: Hash de alta pureza que derrete completamente quando aquecido, ideal para dabbing.` },
  ...
  { title: "Como ter acesso?", content: `Assine por 6 meses e tenha acesso aos nossos Mádicos prescritores e Fornecedores que receitam e enviam a extração de THC Ice: Uma técnica que permite obter um concentrado de cannabis de alta qualidade e sem o uso de solventes químicos. Seu uso medicinal pode ser benéfico, desde que seja realizado de forma responsável e sob supervisão profissional (converse com quem te entende). É fundamental distinguir entre diferentes formas de cannabis e seus efeitos para garantir um tratamento seguro e eficaz.` },
];
