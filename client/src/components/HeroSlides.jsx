...
      <h1 className="hero-title" translate="no" lang="en">WS | Connection</h1>
...
          Escolha um Plano de Contratação. Consulte com um de nossos Médicos Especialista e escolha seus Fornecedores das Melhores Espécies e Extrações Ricas em THC e CBD, Nacionais e Importadas de forma LEGALIZADA pela ANVISA aqui no BRASIL.
        </p>
      </div>
    </section>
  );
