...
},
{
  ...
  { id: 5, images: ['/images/wsc-import-1.png'], title: 'Piatella | D9', location: '3g', deliveryTime: '15-50 dias úteis', price: 'WSC-879,00', description: 'SOB ENCOMENDA - Um concentrado sem solvente elaborado através de um meticuloso processo de cura a frio. (78,09% CANAB.)', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-879/' },
  { id: 6, images: ['/images/wsc-import-2.png'], title: '00 SIFT | D9', location: '3g', deliveryTime: '15-50 dias úteis', price: 'WSC-749,00', description: 'SOB ENCOMENDA - Concentrado da primeira e mais fina peneiração a seco. (70,77% CANAB.)', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/00/' },
  { id: 7, images: ['/images/wsc-import-3.png'], title: 'Gold Seal | D9', location: '3g', deliveryTime: '15-50 dias úteis', price: 'WSC-759,00', description: 'SOB ENCOMENDA - Concentrado artesanal que celebra os métodos afegãos de resinas prensadas à mão. (70,11% CANAB.)', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-759/' },
  { id: 8, images: ['/images/wsc-import-4.png'], title: 'THCA Sugar | D9', location: '3g', deliveryTime: '15-50 dias úteis', price: 'WSC-849,00', description: 'SOB ENCOMENDA - Concentrado premium de cera cristalizada com alto teor de THCA. (80,08% CANAB.)', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-849/' },
  { id: 9, images: ['/images/wsc-import-5.png'], title: 'Ketama Gold | D9', location: '3g', deliveryTime: '15-50 dias úteis', price: 'WSC-719,00', description: 'SOB ENCOMENDA - Textura suave e cremosa com tons dourados, processo de altíssima qualidade. (70,64% CANAB.)', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-719/' },
  { id: 10, images: ['/images/wsc-import-6.png'], title: 'La mousse | D9', location: '3g', deliveryTime: '15-50 dias úteis', price: 'WSC-749,00', description: 'SOB ENCOMENDA - Combina técnicas tradicionais de peneiramento seco, conhecido pela textura rica. (53,09% CANAB.)', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-749/' },
  { id: 11, images: ['/images/wsc-import-7.png'], title: 'Temple Ball | D9', location: '3g', deliveryTime: '15-50 dias úteis', price: 'WSC-729,00', description: 'SOB ENCOMENDA - Resultado da lendária tradição nepalesa esfregada à mão. (75,92% CANAB.)', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-729/' },
  { id: 12, images: ['/images/wsc-import-8.png'], title: 'Static Sift | D9', location: '3g', deliveryTime: '15-50 dias úteis', price: 'WSC-829,00', description: 'SOB ENCOMENDA - Resina refinada criada por meio de separação estática moderna. (79,01% CANAB.)', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-829/' },
  { id: 13, images: ['/images/wsc-import-9.png'], title: 'THCA Budder | D9', location: '3g', deliveryTime: '15-50 dias úteis', price: 'WSC-849,00', description: 'SOB ENCOMENDA - Consistência cremosa e efeitos potentes, equilíbrio entre edificante e relaxante. (94,1% CANAB.)', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-849/' },
  { id: 14, images: ['/images/wsc-import-10.png'], title: 'THCA Rosin | D9', location: '3g', deliveryTime: '15-50 dias úteis', price: 'WSC-869,00', description: 'SOB ENCOMENDA - Extrato obtido sem solventes através de calor e pressão. (61,28 CANAB.) Resina translúcida.', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-869/' },
  { id: 15, images: ['/images/wsc-import-11.png'], title: 'Diamond Sauce Papaya THCa', location: '10g', deliveryTime: '15-50 dias úteis', price: 'WSC-1489,00', description: 'SOB ENCOMENDA - THCa Diamantes formados a partir de extração a frio. Genética Papaya (Indica).', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-1489/' },
  { id: 16, images: ['/images/wsc-import-11.png'], title: 'Diamond Sauce OG Kush THCa', location: '10g', deliveryTime: '15-50 dias úteis', price: 'WSC-1489,00', description: 'SOB ENCOMENDA - THCa Cristais puros com mistura de terpenos. Genética OG Kush (Híbrida).', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-1489/' },
  { id: 17, images: ['/images/wsc-import-11.png'], title: 'Diamond Sauce Diesel THCa', location: '10g', deliveryTime: '15-50 dias úteis', price: 'WSC-1489,00', description: 'SOB ENCOMENDA - O THC-A se transforma em THC quando aquecido. Genética Sour Diesel (Sativa).', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-1489/' },
  { id: 18, images: ['/images/wsc-import-12.png'], title: 'Diamond CBD Zkittlez', location: '10g', deliveryTime: '15-50 dias úteis', price: 'WSC-1199,00', description: 'SOB ENCOMENDA - Extração a frio. Genética Zkittlez (Sativa): Criatividade e foco.', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-1199/' },
  { id: 19, images: ['/images/wsc-import-12.png'], title: 'Diamond CBD Berry White', location: '10g', deliveryTime: '15-50 dias úteis', price: 'WSC-1199,00', description: 'SOB ENCOMENDA - Genética Berry White (Indica): Relaxamento e sono profundo.', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-1199/' },
  { id: 20, images: ['/images/wsc-import-12.png'], title: 'Diamond CBD Kush Mints', location: '10g', deliveryTime: '15-50 dias úteis', price: 'WSC-1199,00', description: 'SOB ENCOMENDA - Genética Kush Mints (Híbrida): Relaxamento e alívio.', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-1199/' },
  { id: 21, images: ['/images/wsc-import-13.png'], title: 'Diamond D8 Gelato', location: '10g', deliveryTime: '15-50 dias úteis', price: 'WSC-1259,00', description: 'SOB ENCOMENDA - Delta-8 oferece efeitos mais suaves que o Delta-9. Genética Gelato.', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-1259/' },
  { id: 22, images: ['/images/wsc-import-13.png'], title: 'Diamond D8 Grape Ape', location: '10g', deliveryTime: '15-50 dias úteis', price: 'WSC-1259,00', description: 'SOB ENCOMENDA - Genética Grape Ape (Indica): Relaxamento e sono. Terpenos naturais.', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-1259/' },
  { id: 23, images: ['/images/wsc-import-13.png'], title: 'Diamond D8 Durban Poison', location: '10g', deliveryTime: '15-50 dias úteis', price: 'WSC-1259,00', description: 'SOB ENCOMENDA - Genética Durban Poison (Sativa): Energia e foco.', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-1259/' },
  { id: 24, images: ['/images/wsc-import-14.png'], title: 'Live Rosin Blue Dream THCa', location: '10g', deliveryTime: '15-50 dias úteis', price: 'WSC-1459,00', description: 'SOB ENCOMENDA - Rosin Vivo feito com flores frescas congeladas (Fresh Frozen).', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-1459/' },
  { id: 25, images: ['/images/wsc-import-14.png'], title: 'Live Rosin Watermelon THCa', location: '10g', deliveryTime: '15-50 dias úteis', price: 'WSC-1459,00', description: 'SOB ENCOMENDA - Extração ICE do material fresco, prensado até consistência ideal.', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-1459/' },
  { id: 26, images: ['/images/wsc-import-14.png'], title: 'Live Rosin Maui Wowie THCa', location: '10g', deliveryTime: '15-50 dias úteis', price: 'WSC-1459,00', description: 'SOB ENCOMENDA - Genética Maui Wowie (Sativa): Euforia e ânimo premium.', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-1459/' },
  { id: 27, images: ['/images/wsc-import-15.png'], title: 'Bubble Hash Blackberry CBD', location: '10g', deliveryTime: '15-50 dias úteis', price: 'WSC-1249,00', description: 'SOB ENCOMENDA - Feito com água gelada para separar os tricomas. Relaxamento. (CBD)', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-1249/' },
  { id: 28, images: ['/images/wsc-import-15.png'], title: 'Bubble Hash Chocolope CBD', location: '10g', deliveryTime: '15-50 dias úteis', price: 'WSC-1249,00', description: 'SOB ENCOMENDA - Alto teor de canabinoides. Genética Chocolope (Sativa): Euforia. (CBD)', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-1249/' },
  { id: 29, images: ['/images/wsc-import-15.png'], title: 'Bubble Hash Wedding Cake CBD', location: '10g', deliveryTime: '15-50 dias úteis', price: 'WSC-1249,00', description: 'SOB ENCOMENDA - Genética Wedding Cake (Híbrida): Relaxamento e equilíbrio. (CBD)', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-1249/' },
  { id: 30, images: ['/images/wsc-import-16.png'], title: 'Vegan Gummies Sleep CBD', location: '113g', deliveryTime: '15-50 dias úteis', price: 'WSC-529,00', description: 'SOB ENCOMENDA - Gomas veganas sabor Mix de Frutas (60mg/GUMMY). CBN para auxílio no sono. (20 unid)', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-529/' },
  { id: 31, images: ['/images/wsc-import-17.png'], title: 'CBN Tincture Sleep CBD', location: '30ml', deliveryTime: '15-50 dias úteis', price: 'WSC-629,00', description: 'SOB ENCOMENDA - Óleo de CBN de alta concentração com CBD (200mg/ml). Diluição em MCT.', cta: 'IMPORT', link: 'https://ws-connectioncommerce.com/produto/wsc-629/' },
  {
    id: 143,
